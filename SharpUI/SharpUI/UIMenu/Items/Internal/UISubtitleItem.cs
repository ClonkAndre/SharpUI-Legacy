...
namespace SharpUI.UIMenu {
    internal class UISubtitleItem : UIItemBase {
        ...
        public override void Draw(UIMenu menu, D3DGraphics gfx, Point pos)
        {
            ...
            gfx.DrawString(menu.FontOverride, Subtitle, new Rectangle(new Point(pos.X + 5, pos.Y), new Size(menu.ItemSize.Width - 5, menu.ItemSize.Height)), eD3DFontDrawFlags.Left | eD3DFontDrawFlags.VerticalCenter, Style.ForegroundColor);
